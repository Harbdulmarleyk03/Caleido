...
class BookingFactory(factory.django.DjangoModelFactory):
    ...
    start_time = factory.Faker("future_datetime", end_date="+30d", tzinfo=dt_timezone.utc)
    end_time = factory.LazyAttribute(lambda obj: obj.start_time + timedelta(minutes=30))
    idempotency_key = factory.Faker("uuid4")  
    status = "confirmed"
    invitee = factory.RelatedFactory("apps.bookings.tests.factories.InviteeFactory", factory_related_name="booking",)
