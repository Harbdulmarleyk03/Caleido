...
class Invitee(AbstractBaseModel):
    booking = models.OneToOneField(
        Booking, on_delete=models.CASCADE, related_name="invitee"
    )
...
class BookingAnswer(AbstractBaseModel):
    booking = models.ForeignKey(
        Booking, on_delete=models.CASCADE, related_name="answers", db_index=True
    )
    question = models.ForeignKey(
        "events.EventTypeQuestion",
...
class BookingAudit(models.Model):
    ...
    booking = models.ForeignKey(
        Booking, on_delete=models.CASCADE, related_name="audit_logs", db_index=True
    )
